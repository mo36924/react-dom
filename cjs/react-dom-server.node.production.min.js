...
exports.pipeToNodeWritable=function(a,b,c){var d=Mc(a,b,c),e=!1;Jc(d);return{startWriting:function(){e||(e=!0,Kc(d),b.on("drain",Lc(b,d)))},abort:function(){try{var a=d.abortableTasks;a.forEach(Bc,d);a.clear();1===d.status&&Cc(d)}catch(f){Y(d,f),tc(d,f)}}}};exports.version="18.0.0-b9934d6db-20210805";
