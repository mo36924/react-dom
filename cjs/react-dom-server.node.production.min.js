...
exports.pipeToNodeWritable=function(a,b,c){var d=Nc(a,b,c),e=!1;Kc(d);return{startWriting:function(){e||(e=!0,Lc(d),b.on("drain",Mc(b,d)))},abort:function(){try{var a=d.abortableTasks;a.forEach(Cc,d);a.clear();1===d.status&&Dc(d)}catch(f){Y(d,f),tc(d,f)}}}};exports.version="18.0.0-ed6c091fe-20210701";
